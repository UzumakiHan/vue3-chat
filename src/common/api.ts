...
export const searchVueChatAccount = (userInfo: ISearchVueChatAccount) =>
    post(`${BASE_URL  }/user/searchVueChatAccount`, userInfo);
...
// 获取好友们朋友圈
export const getAllFriendsWechatMoments = (info: IGetAllFriendsWechatMoments) =>
    post(`${BASE_URL  }/wechatmoment/allFriendsWechatMoments`, info);
// 获取自己的朋友圈
...
// 点赞朋友圈
export const likeWechatMoment = (wechatMoment: ILikeWechatMoment) =>
    post(`${BASE_URL  }/wechatmoment/likeWechatMoment`, wechatMoment);
// 取消点赞
export const unLikeWechatMoment = (wechatMoment: ILikeWechatMoment) =>
    post(`${BASE_URL  }/wechatmoment/unLikeWechatMoment`, wechatMoment);
// 更改密码
...
// 更改群昵称
export const editChatRoomName = (chatRoomInfo: IEditChatRoomName) =>
    post(`${BASE_URL  }/chatroom/editChatRoomName`, chatRoomInfo);
// 更改群公告
export const editChatRoomAd = (chatRoomInfo: IEditChatRoomAd) =>
    post(`${BASE_URL  }/chatroom/editChatRoomAd`, chatRoomInfo);
// 获取单个聊天室信息
export const getChatRoomInfo = (id: string) => post(`${BASE_URL  }/chatroom/getChatRoomInfo`, {id});
// 移除群成员
export const removeChatMember = (removeInfo: IRemoveChatMember) =>
    post(`${BASE_URL  }/chatroom/removeChatMember`, removeInfo);
// 获取单个聊天室信息
export const cleanChatList = (sendAccountAndchatRoomId: string) =>
    post(`${BASE_URL  }/chatlist/cleanChatList`, {sendAccountAndchatRoomId});
// 群主退出群聊

export const deleteChatOwner = (removeInfo: IDeleteChatOwner) =>
    post(`${BASE_URL  }/chatroom/deleteChatOwner`, removeInfo);
// 获取首页群聊的记录
